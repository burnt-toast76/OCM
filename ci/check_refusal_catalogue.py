...
ALLOWLIST = {
    ...
    # ocm-mcp (ADR-0036): the serving env vars, and the D7 sizing constants
    ...
    # ocm-mcp's coverage-queue env vars (ADR-0036 D1 as amended).
    "OCM_COVERAGE_TOKEN", "OCM_COVERAGE_REPO", "OCM_COVERAGE_DAILY_CAP",
